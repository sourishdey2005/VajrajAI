    ...
    <div className="grid gap-6 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {dashboardStats.map((stat, index) => (
          <Card key={stat.title} className="animate-in fade-in slide-in-from-bottom-12 duration-1000" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="lg:col-span-4 animate-in fade-in slide-in-from-bottom-16 duration-1000" style={{ animationDelay: '200ms' }}>
          <CardHeader>
        ...
        <Card className="lg:col-span-3 animate-in fade-in slide-in-from-bottom-16 duration-1000" style={{ animationDelay: '300ms' }}>
          <CardHeader>
